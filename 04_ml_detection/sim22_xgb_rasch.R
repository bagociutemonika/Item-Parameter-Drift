...
xgb_summary_rasch_2_2 <- data.frame()
...
for(i in 1:length(datasets_2PL_MD)){
  ...
  # Rasch calibration — misspecified for both discrimination and multidimensionality
  ...
  xgb_summary_rasch_2_2 <- rbind(xgb_summary_rasch_2_2, data.frame(
...
xgb_summary_rasch_2_2 <- xgb_summary_rasch_2_2 %>%
  mutate(
